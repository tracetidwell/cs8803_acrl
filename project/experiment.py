...
class Experiment():
    def __init__(self,
                 ...
                 decay_over_epochs = 500 # TODO - arbitrary choice
    ):
    ...
    def load_agent_checkpoint(self, checkpoint_file):
        agent = torch.load(checkpoint_file, self.device)
    ...
    def sample_agent(self,):
        ...
        # Load the agent
        sample_agent = torch.load(random_agent, self.device)
        return sample_agent
    ...
    def evaluate(self, render = False, n = 10): #test - fully deterministic
        ...
        for j in range(n):
            ...
            #print(i)
            #print(r)
            win_a1 = i[0].get('winner' * 1, 0)
            win_a2 = i[1].get('winner' * 1, 0)
            self.logger.store(TestEpRet_a1=ep_ret_a1, TestEpRet_a2=ep_ret_a2, TestEpLen=ep_len, EpWin_a1=win_a1, EpWin_a2=win_a2)
    ...
    def logger_checkpoint(self, epoch, start_time):
        ...
        for key in ['EpLen', 'TestEpLen', 'EpWin_a1', 'EpWin_a2']:
    ...
    def run_experiment(self): # main training loop
        ...
        while self.steps_count < total_steps:
            ...
            if self.steps_count > self.start_steps:
                ...
                actions = np.random.rand(self.n_workers, self.n_agents, self.act_dim)
                actions = (actions - 0.5) * 2 * self.act_limit
...
if __name__ == "__main__":
    ...
    exp = Experiment(
        ...
        agent_checkpoint = 'data/all_sac_d561ba7c/1110000.pt', # best after dagger
        # decay_over_epochs = 200,
        rew_type = 'all',
        exp_name = 'all_sac',
        tags = 'store_both,Gx20'
        # rew_type = 'opponent+envx20',
        # exp_name = 'opponent_sac',
    )
    exp.run_experiment()
